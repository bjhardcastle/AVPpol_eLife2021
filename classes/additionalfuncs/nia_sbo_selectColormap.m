function colormap_spec = nia_sbo_selectColormap(fig, ch_ids, hist_info, callback)
...
[hist_info_ok, hist_info_msg] = nia_sbo_hasValidFieldNames(...
...
for ch_idx=1:num_ch
    ...
    switch chan_list(ch_idx).cmap
        ...
        case 9
            % uni1 colormap
            cmap = nia_sbo_colormapUni1;
            nan_color = [1, 1, 1];
        case 10
            % uni2 colormap
            cmap = nia_sbo_colormapUni2;
            nan_color = [1, 1, 1];
    end
