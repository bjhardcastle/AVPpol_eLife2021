function axesAnatomyLabelsL(ax)
...
zticklabels(ax,ticks)
   ...
   if strcmp(ax.XTickLabel(2),' ')
    ...
    elseif  strcmp(ax.XTickLabel(2),'m')
          ax.XTickLabel{2} = [num2str(ax.XTick(2)) ' \mum      m'];
   end 
...
%     ax.XRuler.Axle.VertexData(1,2) = ax.XTick(2);
%         ax.XRuler.Axle.VertexData(2,1) = ax.XTick(1);
%     ax.XRuler.Axle.VertexData(2,2) = ax.XTick(2);
%      ax.XRuler.Axle.VertexData(3,1) = ax.XTick(1);
%     ax.XRuler.Axle.VertexData(3,2) = ax.XTick(2);
