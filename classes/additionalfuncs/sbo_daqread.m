function [data, time, abstime, eventinfo, daqinfo] = sbo_daqread(filename, varargin)
%DAQREAD Read Data Acquisition Toolbox (.daq) data file.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Formerly daqread.m Renamed and replaced with new function which does not include Matlab copyrighted code - April 2019
%
% %%%% THIS IS A BUILT-IN MATLAB FUNCTION, CUSTOMIZED FOR THE  SLIDEBOOK
% OBJ CLASS + SESSION-BASED INTERFACE MATLAB (POST 2015). This is a
% built-in Matlab function which has been customized slightly. Post Matlab
% 2015 using the session-based daq interface we could no longer create .daq
% files that were compatible with daqread, so we made our own with a unique
% fid: 'SlbObj Data Acquisition File.'. This version of daqread simply
% recognizes those files and extracts the data appropriately 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% MODIFIED CODE: BEN 2018/09 FOR FAKE .DAQ FILES CREATED WITH
