function [responseArray, timeVector, F0Array, ObjIdx,stimTimeArray] = findRespArrayExp4Rev(objarray, ROImaskidx, fields)
...
if  (ismember(polExp,objarray(oidx).TrialSeqNum)) && ...  % regular pol mapping exists
            ...
            ( ~isfield(objarray(oidx).pSet(polExp),'StepDIR') || objarray(oidx).pSet(polExp).StepDIR == 5  ) && ...  % mapping was in the opposite to regular direction
