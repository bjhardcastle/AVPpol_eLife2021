function F0 = findF0Exp4(obj, mask, trialData,  trialIdx, timeVector, normFPS)
...
% find RMS of mapping exp:
F0_try = sqrt(nanmean(trialData.^2));

% find mean of mapping exp:
% F0_try = mean(trialData);
