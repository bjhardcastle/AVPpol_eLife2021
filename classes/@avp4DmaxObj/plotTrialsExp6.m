function varargout = plotTrialsExp6(objarray, ROImaskidx, fields, errorbar, plotcolor, tfig)
...
[responseArray, timeVector, F0Array, respIdx,stimTimeArray] = findRespArrayExp6(objarray, ROImaskidx, fields);
