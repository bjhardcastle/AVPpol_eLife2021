...
%%
[a5 a5angles]= getExp5ActivityFrame(obj);
...
figure,
bentitle('within-trial');
subplot(1,2,1),imagesc(imcomplement(X1+X15+X2+X25+X3)),axis image
subplot(1,2,2),imagesc(imcomplement(X2+X25+X3)),axis image
...
subplot(1,5,4),imagesc(X25),axis image
subplot(1,5,5),imagesc(X3),axis image
bentitle('post- minus within-trial');
