function varargout = plotTrialsExp4(objarray, ROImaskidx, fields, errorbar, plotcolor, tfig)
...
[responseArray, timeVector, F0Array, respIdx,stimTimeArray] = findRespArrayExp4(objarray, ROImaskidx, fields);
