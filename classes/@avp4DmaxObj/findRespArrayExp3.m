function [responseArray, timeVector, F0Array, ObjIdx] = findRespArrayExp3(objarray, ROImaskidx, fields)
...
%             secframes = ceil(objarray(oidx).AIrate ./ objarray(oidx).IFI);
            ...
            F0_returned( tcount, : ) = findF0Exp3( objarray(oidx), mask, trials_returned( tcount , : ),tidx, timeVector, normFPS  );
