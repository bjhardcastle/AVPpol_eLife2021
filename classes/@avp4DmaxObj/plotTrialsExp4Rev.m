function varargout = plotTrialsExp4Rev(objarray, ROImaskidx, fields, errorbar, plotcolor, tfig)
...
[responseArray, timeVector, F0Array, respIdx,stimTimeArray] = findRespArrayExp4Rev(objarray, ROImaskidx, fields);
