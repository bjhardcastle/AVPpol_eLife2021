function varargout = plotTrialsExp5(objarray, ROImaskidx, fields, errorbar, plotcolor, tfig)
...
[responseArray, timeVector, F0Array, respIdx,stimTimeArray] = findRespArrayExp5(objarray, ROImaskidx, fields);
