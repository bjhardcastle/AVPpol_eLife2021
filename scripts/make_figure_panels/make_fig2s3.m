...
pathsAVP
if exist(fullfile(fig2s3path),'dir')
    try rmdir(fullfile(fig2s3path),'s'),end
end
...
superXY(x(pos_set),0,1,0,[],1,1,0,2)
suffix = '_pos_tuning';
printAVP
...
superXY(x(neg_set),0,1,0,[],1,1,0,2)
suffix = '_neg_tuning';
printAVP
...
superXY(x(other_set),0,1,0,[],1,1,0,2)
